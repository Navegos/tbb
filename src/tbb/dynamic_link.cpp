...
#if _WIN32
        bool res = GetModuleHandleEx(0, reinterpret_cast<UNICODE_LPCSTR>(library), &library_handle);
...
#endif /* _WIN32 */
            dynamic_link_handle library_handle = dlopen(reinterpret_cast<UNICODE_LPCSTR>(path), RTLD_LAZY | RTLD_GLOBAL );
#if _WIN32
